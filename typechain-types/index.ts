...
export type { MockPlonkVerifier } from "./contracts/lib/MockPlonkVerifier";
export { MockPlonkVerifier__factory } from "./factories/contracts/lib/MockPlonkVerifier__factory";
